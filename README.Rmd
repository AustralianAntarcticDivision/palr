...
[![Windows Build Status](https://ci.appveyor.com/api/projects/status/github/mdsumner/palr?branch=master&svg=true)](https://ci.appveyor.com/project/mdsumner/palr)
