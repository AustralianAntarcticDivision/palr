...
[![R-CMD-check](https://github.com/AustralianAntarcticDivision/palr/workflows/R-CMD-check/badge.svg)](https://github.com/AustralianAntarcticDivision/palr/actions)
<!-- badges: end -->
